...
devtools::install_github("tnaake/MatrixQCvisUtils")
```
...
## from xlsx files and LFQ-normalized intensities
...
spectronaut(file = file, sheetIntensitities = 1, sheetAnnotation = 2)
```
